 ...
 */
export function buildDesignProcessSkill(): string {
  return `---
name: design-process
description: The method for designing this invitation — ground it in the couple's material, plan, review the plan against the genre's defaults, then build. Read this before writing any code on a first build.
---
...
If the couple uploaded reference images or fonts, those are the strongest signal
you have. Look at them before you plan.
