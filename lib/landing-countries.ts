...
// markets in lib/currency/config.ts: PT is the EUR home market; the rest each
// map to their own currency. The "other countries" case is communicated
// separately in the hero, so it is intentionally not part of this list.
export const SERVED_COUNTRY_CODES = ["PT", "BR", "AO", "MZ", "US"] as const;
