              ...
              {items.map((item, index) => {
                ...
                return (
                  <motion.article
                    ...
                    className={`group flex h-full flex-col overflow-hidden rounded-[1.5rem] transition ${
                      featured
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-3 p-6 pt-3">
                      ...
                      <a
                        ...
                        className={`shrink-0 rounded-full px-4 py-2 text-xs font-semibold transition focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${
                          featured
