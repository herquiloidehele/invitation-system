  ...
  return (
    <div className="sticky bottom-0 z-30 flex gap-2 border-t border-border/70 bg-background/95 px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 backdrop-blur-xl lg:hidden">
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="inline-flex min-h-[46px] basis-2/5 items-center justify-center gap-2 rounded-full bg-background px-3 text-[13px] font-semibold text-foreground shadow-[inset_0_0_0_1.5px_color-mix(in_srgb,var(--foreground)_16%,transparent)] transition-transform duration-200 active:scale-[0.97] focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
      >
